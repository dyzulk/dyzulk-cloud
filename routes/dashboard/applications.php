...
Route::name('applications.')->group(function () {
    ...
    Route::inertia('applications/resources', 'dashboard/applications/resources')->name('resources');
    Route::inertia('applications/usage', 'dashboard/applications/usage')->name('usage');
