...
export function CreateSshKeyDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={(val) => {
            ...
            <DialogContent className="max-w-xl border-2 border-border shadow-shadow font-base p-6">
                    ...
                    <div className="max-h-[55vh] overflow-y-auto pr-2 -mr-2 space-y-4">
                        ...
                        <div className="space-y-2">
                            {!showGenerator ? (
                                <button
                                    ...
                                    className="flex items-center gap-1.5 text-xs text-main hover:underline font-heading"
                                >
                                    <Sparkles className="h-3.5 w-3.5" />
                                    Generate a new SSH key pair instead
                                </button>
                            ) : (
                                <div className="p-4 rounded-base border-2 border-dashed border-border bg-secondary-background/30 space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] opacity-80 mt-0.5">Highly compatible standard</span>
                                        </button>
                                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="min-h-[120px] font-mono text-xs border-2 border-border bg-background"
                        ...
                        {generatedPublicKey && (
                            <div className="space-y-2 p-3 bg-green-500/10 text-green-700 dark:text-green-500 rounded-base border-2 border-green-500/20 text-xs">
                                ...
                                <Textarea
                                    readOnly
                                    className="min-h-[50px] font-mono text-[10px] border border-green-500/20 bg-background/50 focus-visible:ring-0 text-foreground"
