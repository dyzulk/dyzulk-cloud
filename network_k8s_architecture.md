...
### 4.8 Cloudflare for SaaS Integration Details
...
3. **K3s Initialization**: Install K3s server on `paas-k3s-master` (keeping default Traefik enabled to act as the single local ingress controller).
